...
const TechStackIcon = ({ TechStackIcon: IconComponent, Language }) => {
  return (
    <div className="group p-6 rounded-2xl bg-slate-800/50 hover:bg-slate-700/50 transition-all duration-300 ease-in-out flex flex-col items-center justify-center gap-3 hover:scale-105 cursor-pointer shadow-lg hover:shadow-xl">
      <div className="relative">
        ...
        <div className="relative h-16 w-16 md:h-20 md:w-20 flex items-center justify-center transform transition-transform duration-300">
          <IconComponent className="w-12 h-12 md:w-16 md:h-16 text-white group-hover:text-blue-300 transition-colors duration-300" />
        </div>
      </div>
